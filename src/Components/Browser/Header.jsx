...
const Header = () => {
  return (
    <header className='fixed top-0 z-50 flex w-full items-center justify-between bg-[#141414] p-4 lg:px-10 lg:py-6' >
     ...
     <div className='flex'>
            <Link to='/Browser' className='Link-stayle'> Home</Link>
            <Link to='/TvShows' className='Link-stayle'> TvShows</Link>
            <Link to='/Browser' className='Link-stayle'> Movies</Link>
            <Link to='/Browser' className='Link-stayle'> Latest</Link>
            <Link to='/Browser' className='Link-stayle'>My List</Link>
        </div>
        </div>
         ...
         <img src='./images/logo/profile.png' className='w-[40px] rounded cursor-pointer'/>
